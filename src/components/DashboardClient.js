...
export function DashboardClient({ initialBookmarks }) {
  ...
  return (
    <>
      {/* Header Section */}
      <div id="dashboard" className="scroll-mt-24 mb-8 flex flex-col gap-4 rounded-xl border bg-background p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="inline-flex h-10 items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring"
          >
      ...
      {/* Search and Filters */}
      <div className="mb-6 flex flex-col gap-4 rounded-xl border bg-background p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        {/* Search Bar */}
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm md:col-span-2">
          ...
          <div className="p-6">
            {filteredBookmarks.length === 0 ? (
              <div className="flex h-[300px] items-center justify-center rounded-md border border-dashed border-border/60 bg-muted/10 transition-all animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="flex flex-col gap-6">
          <div id="collections" className="scroll-mt-24 rounded-xl border bg-card p-6 text-card-foreground shadow-sm">
          ...
          <div id="settings" className="scroll-mt-24 rounded-xl border bg-card p-6 text-card-foreground shadow-sm">
